...
int init_expression_part_operation(expression_part_t **expression_part, const operation_t operation)
{
    if (expression_part == NULL || *expression_part != NULL)
        return 1;
...
int init_expression_part_parentheses(expression_part_t **expression_part, const parentheses_t parentheses)
{
    if (expression_part == NULL || *expression_part != NULL)
        return 1;
    init_expression_part(expression_part);
